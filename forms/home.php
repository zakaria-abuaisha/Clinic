...
<body class="bg-cyan-400">
  <nav class="p-4 bg-white shadow md:flex  md:justify-between">
    ...
    <ul class="md:flex md:items-center">
      ...
      <li class="mx-4 my-6 md:my-0">
        <a href="#" class="text-xl hover:text-blue-600 duration-300">Patient</a>
      </li>
      <li class="mx-4 my-6 md:my-0">
        <a href="#" class="text-xl hover:text-blue-600 duration-300">Doctors</a>
      </li>
      <li class="mx-4 my-6 md:my-0">
        <a href="#" class="text-xl hover:text-blue-600 duration-300">Appointments</a>
      </li>
      <button class="bg-cyan-400 text-white duration-300 px-6 py-2 mx-4 hover:bg-cyan-700 rounded">
        Get Started
      </button>
    </ul>
