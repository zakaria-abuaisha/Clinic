...
<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST")
    {
        ...
        {
            $errors["user_exists"] = "Username already used.";
        }
        ...
        if(!count($errors))
        {
            try{
                ...
                $sql = "INSERT INTO patient ( U_No, Name, Gender, Nationality, Telephone, Email) VALUES ( :U_No, :Name, :Gender, :Nationality, :Telephone, :Email)";
                $stmt = $db->prepare($sql);
                $stmt->bindParam(':U_No', $last_inserted_id, PDO::PARAM_INT);
